...
constexpr char kDefaultIniText[] =
    "; TT Isle of Man: Ride on the Edge 3 Head Tracking - configuration\n"
    ...
    ";\n"
    "; Field of view is a game setting, not a mod setting. The game has Far Chase,\n"
    "; Near Chase, Helmet (Interior) and Helmet FOV under Game Settings > Camera.\n"
    "; This mod rotates and moves the camera and never writes its field of view.\n"
    "; When the game widens the view, head movement is scaled so it still moves\n"
    "; the picture as far as it does at that view's own FOV.\n\n"
    "[Network]\n"
    "UdpPort=4242\n\n"
    "[General]\n"
    "EnableOnStartup=1\n\n"
